...
PASSWORD_SECRET = "Respect112833"  # يمكنك تغيير كلمة المرور من هنا
...
st.write("أدخل القصة للتحقق من الشروط المعتمدة لكاشف قصص ريسبكت وفحص الذكاء الاصطناعي.")
...
system_prompt = """
أنت مدقق مخصص لقصص سيرفر "ريسبكت" (Respect RP) ومستكشف للنصوص التوليدية (AI Detector). قم بمراجعة القصة وتوفير التقييم بالتنسيق التالي:
...
3. **تفصيل شروط سيرفر ريسبكت:**
   - (الاسم الثلاثي وسنة الميلاد والمنشأ): [مستوفى / غير مستوفى]
   - (الواقعية والتسلسل العمري والأحداث): [مستوفى / غير مستوفى]
   - (حدث محوري/مؤلم في الطفولة أثر على الشخصية): [مستوفى / غير مستوفى]
   - (الاهتمامات، الطموحات، السلبيات والإيجابيات): [مستوفى / غير مستوفى]
   - (عدم تحديد الوظيفة أو المسار المباشر والاكتفاء بالتلميح): [مستوفى / غير مستوفى]
   - (خلو القصة من أحداث داخل السيرفر): [مستوفى / غير مستوفى]
